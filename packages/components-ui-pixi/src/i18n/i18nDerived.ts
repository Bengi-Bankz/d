...
export const i18nDerived = {
	...
	bonusBet: () =>
		stateUrlDerived.social() ? 'BONUS SPIN' : stateI18nDerived.translate('BONUS BET'),
	stop: () => stateI18nDerived.translate('STOP'),
	buyBonus: () =>
		stateUrlDerived.social() ? 'PLAY BONUS' : stateI18nDerived.translate('BUY BONUS'),
	...
	payTable: () => (stateUrlDerived.social() ? 'TABLE' : stateI18nDerived.translate('PAYTABLE')),
